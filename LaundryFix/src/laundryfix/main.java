...
public class main {
    static Client client = new Client();//object yang saling memanggil method dari satu object ke object lainnya
    ...
    public static void main(String[] args){
        System.out.println("--- LAUNDRY MURAH BANGETTT ---");
        System.out.println("Apakah anda sudah memiliki member?(ya/tidak)");
    ...
    public static void menu(int id){
        while(tetap){
            ...
            if(menu==1){
                ...
                System.out.println("====Jam Operasional====");
                    System.out.println("Hari" + "\t" + "Jam");  
                    
                    Libur obj = new Jumat ();
                    System.out.println(obj.Libur());
